...
fig= ff.create_distplot([mscore],['Maths Score'],show_hist=False)
fig.show()

fig1= ff.create_distplot([rscore],['Reading Score'],show_hist=False)
fig1.show()

fig1= ff.create_distplot([wscore],['Wrinting Score'],show_hist=False)
fig1.show()

# sd for wscore

first_stdev_start,first_stdev_end= mean-sd,mean+sd
second_stedv_start,second_stdev_end= mean-2*sd,mean+2*sd
